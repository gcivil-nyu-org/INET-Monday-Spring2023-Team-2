...
class VolunteerChangeFormTest(TestCase):
    ...
    def test_validation(self):
        ...
        self.assertFalse(self.user.first_name == "R2D2")
        self.assertFalse(self.user.last_name == "Robot")
        self.assertFalse(
            self.user.date_of_birth
            == datetime.strptime("2000-01-01", "%Y-%m-%d").date()
        )
        self.assertFalse(self.user.badges == "badge-2,badge-4")
        self.assertFalse(self.user.description == "beep_boop")
        data = {
            "first_name": "R2D2",
            "last_name": "Robot",
            "date_of_birth": "2000-01-01",
        ...
        self.assertTrue(self.user.first_name == "R2D2")
        self.assertTrue(self.user.last_name == "Robot")
        self.assertTrue(
            self.user.date_of_birth
            == datetime.strptime("2000-01-01", "%Y-%m-%d").date()
        )
        self.assertTrue(self.user.badges == "badge-2,badge-4")
        self.assertTrue(self.user.description == "beep_boop")
...
class OrganizationChangeFormTest(TestCase):
    ...
    def test_validation(self):
        ...
        self.assertFalse(self.user.name == "Dije")
        self.assertFalse(self.user.website == "www.google.com")
        self.assertFalse(self.user.description == "beep_boop")
        data = {
            "name": "Dije",
        ...
        self.assertFalse(form.save())
        self.assertTrue(self.user.name == "Dije")
        self.assertTrue(self.user.website == "www.google.com")
        self.assertTrue(self.user.description == "beep_boop")
